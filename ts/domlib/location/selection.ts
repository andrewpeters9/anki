...
import { getRange, getSelection } from "../../lib/cross-browser.ts";
import type { CaretLocation } from "./location.ts";
import { compareLocations, Position } from "./location.ts";
import { getNodeCoordinates } from "./node.ts";
